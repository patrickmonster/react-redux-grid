...
class MenuItem extends Component {
    render() {
        ...
        const { data, disabled, metaData, menuItemsTypes, stateKey } =
            this.props;
    ...
    handleMenuItemClick(data, disabled, metaData, stateKey, reactEvent) {
        ...
        const dismiss =
            data.dismissOnClick !== undefined ? data.dismissOnClick : true;
    ...
    getCheckbox(data) {
        const readOnly = data.hideable !== undefined ? !data.hideable : false;
...
export { ConnectedMenuItem, MenuItem };

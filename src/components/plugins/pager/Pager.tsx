...
import { Button } from "@/components/plugins/pager/toolbar/Button";
import { Description } from "@/components/plugins/pager/toolbar/Description";
...
export class PagerToolbar extends Component {
    ...
    componentWillUnmount() {
        if (this._scrollTarget) {
            this._scrollTarget.removeEventListener(
                "scroll",
    ...
    createScrollListener(config, footerDOM) {
        ...
        const defaultListener = () => {
            ...
            const shouldStop =
                footerDOM.parentNode.getBoundingClientRect().top + BUFFER >
                window.innerHeight;
...
export const getCustomComponent = (plugins: any) => {
    return plugins && plugins.PAGER && plugins.PAGER.pagerComponent
...
export const getPager = (
    ...
    const pageIndex =
        pager && pager.get("pageIndex") ? pager.get("pageIndex") : 0;
    ...
    const spacer = stuck || stuckBottom ? <div {...spacerProps} /> : null;

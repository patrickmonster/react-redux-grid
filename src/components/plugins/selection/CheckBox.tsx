...
import { gridConfig, SELECTION_MODES } from "@/constants/GridConstants";
...
export const CheckBox = ({
    ...
    const checkBoxContainerProps = {
        className: prefix(
            CLASS_NAMES.SELECTION_MODEL.CHECKBOX_CONTAINER,
            type === "header" &&
    ...
    if (type === "header") {
        ...
        checked =
            selectedRows && selectedRows.count && selectedRows.every((s) => s)
...
export const getColumn = (
    checkBoxContainerProps: React.ComponentPropsWithoutRef<"td">,

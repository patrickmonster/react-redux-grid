...
import { ConnectedCheckBox as CheckBox } from "@/components/plugins/selection/CheckBox";
...
export default class Model {
    init(plugins, stateKey, store, events) {
        ...
        const config =
            plugins && plugins.SELECTION_MODEL
                ? Object.assign(defaults, plugins.SELECTION_MODEL)
                : defaults;
    ...
    updateCells({
        ...
        if (
            this.defaults.mode === this.modes.checkboxSingle ||

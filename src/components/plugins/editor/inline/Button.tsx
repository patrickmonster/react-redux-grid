...
import { gridConfig, KEYBOARD_MAP } from "@/constants/GridConstants";
import { fireEvent } from "@/util/fire";
import { prefix } from "@/util/prefix";

import { dismissEditor, saveRow } from "@/actions/plugins/editor/EditorActions";
...
export class Button extends Component {
    ...
    componentDidMount() {
        const { type, BUTTON_TYPES } = this.props;

        if (!this._EVENT_LISTENER) {
            this._EVENT_LISTENER =
                type === BUTTON_TYPES.SAVE
                    ? this.listenForEnter

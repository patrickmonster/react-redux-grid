...
import { Button } from "@/components/plugins/editor/inline/Button";

import { repositionEditor } from "@/actions/plugins/editor/EditorActions";
...
export class Inline extends Component {
    render() {
        ...
        const { BUTTON_TYPES, editorState, events, stateKey, store } =
            this.props;
...
export const getInputSelector = () => {
    const { CLASS_NAMES } = gridConfig();
    return [
        `.${prefix(CLASS_NAMES.EDITED_CELL)} .${prefix(
